    ...
    <div class="row">
      <div class="container">
        ...
        <ul class="nav-menu list-unstyled">
          <li><a href="#" class="smoothScroll">Home | 홈</a></li>
          <li><a href="#about" class="smoothScroll">About | 소개</a></li>
          <li><a href="#portfolio" class="smoothScroll">Portfolio | 포트폴리오</a></li>
          <li><a href="#resume" class="smoothScroll">Resume | 세부이력</a></li>
...
<!-- 
 ...
 -->
  ...
  <div id="resume" class="text-left paddsection">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="resume-info">
              <a href="resume_01.do"><img src="resources/images/resume_post_01.jpg" class="img-responsive" alt="img"></a>
              <div class="resume-txt">
                <h4><a href="resume_01.do">SO LETS MAKE THE MOST IS BEAUTIFUL</a></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="resume-info">
              <a href="resume_02.do"><img src="resources/images/resume_post_02.jpg" class="img-responsive" alt="img"></a>
              <div class="resume-txt">
                <h4><a href=resume_02.do>WE'RE GONA MAKE DREAMS COMES</a></h4>
                <p class="separator">To an English person, it will seem like simplified English
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="resume-info">
              <a href="resume_03.do"><img src="resources/images/resume_post_03.jpg" class="img-responsive" alt="img"></a>
              <div class="resume-txt">
                <h4><a href="resume_03.do">NEW LIFE CIVILIZATIONS TO BOLDLY</a></h4>
                <p class="separator">To an English person, it will seem like simplified English
                </p>
              </div>
            </div>
...
<!--                 <li><span> Street</span></li> -->
                <li><span>Seoul, South Korea</span></li>
                <li><span>+82 504-0804-1334</span></li>
                <li><span>vaims.yoo@gamil.com</span></li>
              </ul>
  ...
  <div id="footer" class="text-center">
    <div class="container">
      ...
      <div class="credits">
        ...
        -->
        Designed by <a href="https://bootstrapmade.com/"> Bootstrap</a> & <a href="http://localhost:1010/folio">Claire.Yoo</a>
